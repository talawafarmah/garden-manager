    ...
    <main className="min-h-screen bg-stone-50 text-stone-900 pb-20">
      ...
      <header className="bg-emerald-700 text-white p-4 shadow-md sticky top-0 z-10 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button onClick={() => navigateTo('printable_catalog')} className="p-2 bg-emerald-800 rounded-full hover:bg-emerald-600 transition-colors shadow-sm" title="Print Catalog">
